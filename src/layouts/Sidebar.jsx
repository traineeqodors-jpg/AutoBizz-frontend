    ...
    <>
      <div className="hidden lg:block max-h-screen h-screen shrink-0 w-70 bg-btn-100/10 overflow-auto p-4 inset-shadow-sm/20">
        ...
        <ul className="w-full space-y-4 ">
          <li className="w-full hover:-translate-y-0.5 transition-all hover:bg-btn-100/30 text-text/80  hover:text-btn-100 rounded-xl overflow-hidden hover:shadow-md/10 px-3 py-2 ">
