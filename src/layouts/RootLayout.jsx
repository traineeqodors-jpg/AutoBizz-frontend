...
const RootLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-layout dark:bg-none dark:bg-gray-800">
        <Navbar />

        <div className="flex-1 overflow-y-auto scheme-dark scroll-smooth flex flex-col">
