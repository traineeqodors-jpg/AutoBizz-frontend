...
const DeleteDialog = ({
  ...
  return (
    <dialog
      ref={deleteModalRef}
      className="w-[90%] max-w-sm rounded-2xl bg-surface m-auto p-6 shadow-2xl backdrop:bg-black/40 dark:backdrop:bg-gray-700/40  animate-in fade-in zoom-in duration-200"
    >
      <motion.div
