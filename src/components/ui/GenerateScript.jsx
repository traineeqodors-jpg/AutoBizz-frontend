                    ...
                    {documents.length <= 0 ? (
                      ...
                      <>
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-xs font-bold cursor-pointer text-btn-100 hover:bg-btn-50/10 rounded-lg mb-1 flex items-center gap-2 border-b border-gray-50 pb-3"
                        >
                        ...
                        {documents?.map((doc) => (
                          <button
                            key={doc.id}
                            type="button"
                            disabled={selectedFiles.find(
                              (f) => f.id === doc.id,
                            )}
                            onClick={() => addFile(doc)}
                            className="w-full text-left px-4 py-3 text-sm hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer rounded-xl transition-colors flex items-center justify-between group disabled:opacity-30 disabled:cursor-not-allowed"
                          >
