...
const LeadFilter = ({
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-900 space-y-6 shadow-sm dark:shadow-sm dark:shadow-gray-700/30">
