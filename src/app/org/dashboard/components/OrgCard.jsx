...
function OrgCard({ user }) {
  return (
    <div className="h-45 w-full shadow-sm dark:shadow-gray-700/30 rounded-2xl p-5 bg-surface space-y-3 flex items-center gap-4">
      ...
      <div className="space-y-2 w-full">
        <h2 className="text-text text-lg font-bold">Organization Details</h2>
