...
function Leads() {
  ...
  return (
    <div className="min-h-100 bg-surface flex flex-col gap-5 w-full rounded-2xl p-5 shadow-sm dark:shadow-gray-700/30">
      ...
      <div className="w-full space-y-3 h-full">
        {leadsLoading ? (
          ...
          <div className="w-full h-full text-center font-medium flex flex-col justify-center-safe items-center-safe text-sm text-text dark:text-gray-400 space-y-3">
            <img src="/ideation.svg" alt="" className="w-60 object-contain" />
          ...
          leads.map((lead) => (
            <div
              key={lead.id}
              className="flex flex-wrap gap-3 justify-between items-center p-3 bg-back rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-b last:border-none border-b-gray-200 overflow-hidden hover:border-gray-100 cursor-pointer"
            >
              <div className="flex items-center gap-3 justify-evenly">
